...
for nF=1:length(files)
    ...
    if exist([data_path filesep 'Preproc' filesep 'CIcfeblock_ft_' file_name(1:end-4) '.mat'])==0
        
        hdr=ft_read_header([folder_name filesep file_name]);
        load([data_path filesep 'Preproc' filesep 'Icfe_ft_' file_name(1:end-4)],'comp');
        load([data_path filesep 'Preproc' filesep 'cfeblock_ft_' file_name(1:end-4)],'data');
        ...
        save([data_path filesep 'Preproc' filesep 'CIcfeblock_ft_' file_name(1:end-4)],'data');
    end
    toc;
end