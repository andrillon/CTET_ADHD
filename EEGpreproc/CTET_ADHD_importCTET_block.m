...
for nF=1:length(files)
    ...
    if exist([data_path filesep 'Preproc' filesep 'feblock_ft_' file_name(1:end-4) '.mat'])==0
        
        hdr=ft_read_header([folder_name filesep file_name]);
        
        %%% Define epochs
        cfg=[];
        cfg.trialfun            = 'CTET_ADHD_blockfun';
        cfg.table               = table;
        cfg.SubID               = SubID;
        ...
        save([data_path filesep 'Preproc' filesep 'feblock_ft_' file_name(1:end-4)],'data');
